...
class HoldHistoryScreen extends StatefulWidget {
  @override
  _OrderHistoryScreenState createState() => _OrderHistoryScreenState();
}

class _OrderHistoryScreenState extends State<HoldHistoryScreen> {
        ...
        if (load == 1)
          ...
          Expanded(
            child: Column(
              children: [
                Expanded(
                    child: Obx(() => orderController.HoledOrderModel.isNotEmpty
                        ? RefreshIndicator(
                            ...
                            child: ListView.builder(
                                itemCount:
                                    orderController.HoledOrderModel.length,
                                padding: EdgeInsets.all(12),
                                itemBuilder: (context, index) => InkWell(
                                    onTap: () {
                                      Get.to(() => OrderDetailsRecpitScreen(
                                          id: orderController
                                              .HoledOrderModel[index].id!));
                                    },
                                    child: Container(
                                                ...
                                                Expanded(
                                                    child: Column(
                                                      ...
                                                      Row(children: [
                                                        Expanded(
                                                          child: Text(
                                                            '# ${orderController.HoledOrderModel[index].code}',
                                                            style: rubikMedium
                                                                .copyWith(
                                                                    fontSize:
                                                                        20.sp,
                                                            ...
                                                            Row(children: [
                                                              ...
                                                              CustomText(
                                                                text: AppStrings
                                                                        .date
                                                                        .tr +
                                                                    ' : ${orderController.HoledOrderModel[index].receiptDate}',
                                                                fontSize: 14.sp,
                                                              ),
                                                            ]),
                                                            Spacer(),
                                                            Row(children: [
                                                              ...
                                                              CustomText(
                                                                text: AppStrings
                                                                        .period
                                                                        .tr +
                                                                    ' : ${DateConverter.getPeriod(orderController.HoledOrderModel[index].receiptTime!)}',
                                                                fontSize: 14.sp,
                                                              ),
                                                            ]),
                                                            SizedBox(
                        ...
                        : Center(
                            child: Column(
                                ...
                                Obx(() => orderController.HoledOrderModel.isEmpty
                                    ? Container()
                                    : Padding(
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                if (orderController
                                                  ...
                                                  CustomText(
                                                      text: (double.parse(orderController.HoledOrderModel.map((e) => e.total.toString())
                                                                  .toList()
                                                                  .reduce((value, element) =>
                                                                      ((double.parse(value) + double.parse(element)))
                                                                          .toString())) -
                                                              double.parse(orderController.HoledOrderModel.map((e) => e.deliveryPrice.toString())
                                                                  .toList()
                                              ...
                                              children: [
                                                ...
                                                orderController
                                                    ...
                                                    ? CustomText(
                                                        ...
                                                        fontSize: 24.sp)
                                                    : CustomText(
                                                        text: orderController.HoledOrderModel.map(
                                                                (e) => e
                                                                    .deliveryPrice
                                                                    .toString())
                                                            .toList()
