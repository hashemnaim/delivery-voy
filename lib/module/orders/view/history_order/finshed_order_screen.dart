...
class FinshedHistoryScreen extends StatefulWidget {
  @override
  _OrderHistoryScreenState createState() => _OrderHistoryScreenState();
}

class _OrderHistoryScreenState extends State<FinshedHistoryScreen> {
                    ...
                    child: orderController.finshOrderModel.isNotEmpty
                        ? RefreshIndicator(
                            ...
                            child: Obx(() => ListView.builder(
                                itemCount:
                                    orderController.finshOrderModel.length,
                                                  ...
                                                  .reduce((value, element) =>
                                                      ((double.parse(value) +
                                                              double.parse(
                                                                  element)))
                                                          .toString())) -
                                              double.parse(orderController.finshOrderModel
